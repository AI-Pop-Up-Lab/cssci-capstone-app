...
const languageOptions = [
  ...
  { name: "svenska", abbreviation: "swe", flagFile: require(`../assets/images/flags/sweden.png`)},
  { name: "dansk", abbreviation: "dk", flagFile: require(`../assets/images/flags/denmark.png`)},
]
